...
const ProductDetail = () => {
  ...
  return (
    <div style={{ padding: "40px", display: "flex", gap: "40px", width:"100%", height:"400px" , backgroundColor:"gray", marginTop:"0px", lineHeight:"37px",boxShadow:"0 10px 10px black", marginTop:"72px"}}>
